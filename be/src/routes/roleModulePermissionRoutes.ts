...
const validateBody = [
  ...
  check('allowed').optional().isBoolean().withMessage('allowed must be a boolean')
];
...
router.get('/', authMiddleware, requireRoles(['admin']), validate, roleModulePermissionController.getAllRoleModulePermissions);
...
router.post('/', authMiddleware, requireRoles(['admin']), validateBody, validate, roleModulePermissionController.createRoleModulePermission);
router.put('/:id', authMiddleware, requireRoles(['admin']), [...validateId, ...validateBody], validate, roleModulePermissionController.updateRoleModulePermission);
