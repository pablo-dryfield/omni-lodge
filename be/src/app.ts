...
import assistantManagerTaskRoutes from './routes/assistantManagerTaskRoutes.js';
import volunteerAttendanceCheckRoutes from './routes/volunteerAttendanceCheckRoutes.js';
import cleaningSubmissionRoutes from './routes/cleaningSubmissionRoutes.js';
import volunteerMilestoneRoutes from './routes/volunteerMilestoneRoutes.js';
...
import productAliasRoutes from './routes/productAliasRoutes.js';
...
app.use('/api/assistantManagerTasks', volunteerAttendanceCheckRoutes);
app.use('/api/cleaningSubmissions', cleaningSubmissionRoutes);
...
app.use('/api/venueCompensationTerms', venueCompensationTermRoutes);
app.use('/api/venueCompensationTermRates', venueCompensationTermRateRoutes);
app.use('/api/channelNumbers', channelNumbersRoutes);
app.use('/api/venueNumbers', venueNumbersRoutes);
...
app.use('/api/maintenance', maintenanceCommandRoutes);
...
app.use('/api/required-actions', requiredActionRoutes);
