...
import StaffProfile, { type StaffType } from './StaffProfile.js';

@Table({
  tableName: 'staff_profile_type_periods',
  modelName: 'StaffProfileTypePeriod',
  timestamps: true,
  underscored: true,
})
export default class StaffProfileTypePeriod extends Model {
  @PrimaryKey
  @AutoIncrement
  ...
  @BelongsTo(() => StaffProfile, { foreignKey: 'user_id', targetKey: 'userId', as: 'staffProfile' })
  declare staffProfile?: NonAttribute<StaffProfile>;
}
