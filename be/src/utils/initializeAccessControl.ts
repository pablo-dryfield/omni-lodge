...
const defaultPages = [
  ...
  { slug: 'open-bar-control', name: 'Open Bar Control', description: 'Manage open bar service and inventory workflows', sortOrder: 5 },
  ...
  { slug: 'social-media', name: 'Social Media', description: 'Plan, produce, and publish short-form social content', sortOrder: 8 },
  ...
  { slug: 'settings-google-api', name: 'Google API', description: 'Inspect Google OAuth credentials and granted scopes', sortOrder: 26 },
  { slug: 'settings-maintenance', name: 'Maintenance', description: 'Review seeds, migrations, and configuration health', sortOrder: 27 },
];
...
const defaultModules = [
  ...
  { slug: 'open-bar-control-console', name: 'Open Bar Console', pageSlug: 'open-bar-control', description: 'Run bartender and manager open-bar workflows', componentRef: 'OpenBarControl', sortOrder: 1 },
  ...
  { slug: 'social-media-content', name: 'Social Media Content', pageSlug: 'social-media', description: 'Plan and manage Reels, TikToks, and other short-form video content', componentRef: 'SocialMediaPage', sortOrder: 1 },
  ...
  { slug: 'cerebro-admin', name: 'Cerebro Admin', pageSlug: 'cerebro', description: 'Maintain knowledge articles, quizzes, and policy rules', componentRef: 'CerebroAdmin', sortOrder: 2 },
...
'settings-permissions-overview': ['view', 'create', 'update', 'delete'],
    ...
    'settings-module-permissions': ['view', 'create', 'update', 'delete'],
      ...
      'social-media-content': ['view', 'create', 'update', 'delete'],
    ...
    'cerebro-admin': ['view', 'create', 'update', 'delete'],
  ...
  manager: {
    ...
    'finance-reports': ['view', 'create', 'update', 'delete'],
    'cerebro-library': ['view', 'create'],
    'cerebro-admin': ['view', 'create', 'update'],
...
roleModuleMatrix['social-media']['social-media-content'] = ['view', 'create', 'update', 'delete'];
