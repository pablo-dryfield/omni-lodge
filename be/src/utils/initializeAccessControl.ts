...
const defaultModules = [
  ...
  { slug: 'finance-recurring', name: 'Recurring Rules', pageSlug: 'finance', description: 'Automate recurring transactions', componentRef: 'FinanceRecurringRules', sortOrder: 7 },
  { slug: 'finance-budgets', name: 'Budgets', pageSlug: 'finance', description: 'Maintain budgets by category', componentRef: 'FinanceBudgets', sortOrder: 8 },
...
'settings-permissions-modules'],
  owner: ['dashboard', 'bookings', 'bookings-manifest', 'users', 'reports', 'venue-numbers', 'finance', 'settings-venues', 'pays'],
