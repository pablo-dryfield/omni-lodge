...
import { IconAlertCircle, IconArrowsExchange, IconCheck, IconClipboardCheck, IconEye, IconMail, IconReceipt, IconSend, IconUser, IconUserEdit, IconUserMinus, IconUserPlus, IconX } from "@tabler/icons-react";
...
} from "./StaffPayoutReceiptConfirmation";
...
const StaffPayoutReceiptAction = ({
  ...
  <StaffPayoutReceiptConfirmation
    receipt={action.payload.staffPayoutReceipt}
    onConfirm={onConfirm}
    loading={loading}
