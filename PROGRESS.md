...
- Venue compensation terms live under Settings → Venues; each term stores the venue, rate, unit, currency, and effective dates so night reports can snap the correct rate (and surface open-bar costs vs. commission revenue in metrics/reporting).
