...
7. GitHub auto-merges the pull request after required checks pass. Delete the task branch after merge; the repository auto-delete setting handles ordinary same-repo branches.
