...
- Remove tracked `ui/build` from `master`, add it to `.gitignore`, and update `AGENTS.md` in one dedicated commit. Completed by the Phase 6 cleanup branch.
