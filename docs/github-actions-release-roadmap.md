...
- Current follow-up branch: add terminal host-request status polling to the deploy and rollback workflows. Future runs must upload both submit-response evidence and final detached-worker status evidence before they are trusted for dry-run, deploy, or rollback decisions.
